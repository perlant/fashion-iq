...
if __name__ == "__main__":
    ...
    parser.add_argument("--glove_file", type=str, default="dict_x.pt")
    parser.add_argument("--data_set", type=str, default="shirt")
    parser.add_argument(
        "--user_vocab_file", type=str, default="../user_modeling/data/{}_vocab.json"
    )
    parser.add_argument("--save", type=str, default="data/{}_emb.pt")
