...
def preprocess_data_from_xiaoxiao(file_prefix, topic):
    ...
    CAPT = "caption/pair2cap.{}.{}.json"
    LABEL = (
        "data/fashion-IQ/predicted_attributes/{}_attribute_best.pth_{}_attributes.json"
    )
    ...
    for entry in training_json:
        ...
        image0_label = [
            label_dic[x] for x in label_predict[entry["candidate"]]["predict"]
        ]
