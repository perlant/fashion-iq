...
def evaluate(args):
    ...
    ranker = Ranker(
        ...
        image_split_file=SPLIT.format(args.data_set, args.data_split),
    ...
    # load trained models
    image_model = os.path.join(args.model_folder, "image-{}.th".format(args.embed_size))
    ...
    cap_model = os.path.join(args.model_folder, "cap-{}.th".format(args.embed_size))
    ...
    json.dump(
        output,
        open("{}.{}.pred.json".format(args.data_set, args.data_split), "w"),
        indent=4,
    )
    print(
        "eval completed. Output file: {}".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_folder",
        type=str,
        default="models/dress-20190612-112918/",
